  ...
  useEffect(() => {
    ...
    scanner.render(
      async (result) => {
        ...
        if (isDemoMode) {
          alert("✅ In-Time Scan Successful (Demo Mode)");
          return;
        }
        try {
      ...
      <div style={styles.content}>
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>
            Point the camera at the visitor's QR pass to record entry.
          </p>
        </div>
        ...
        <div style={styles.card}>
          {scanResult ? (
            <div style={styles.successBox}>
              ...
              <h2 style={styles.successTitle}>Visitor Checked In</h2>
            ...
            <>
              ...
              <p style={styles.hint}>
                <span style={styles.greenDot} /> Scanner active — align the QR code inside the frame
              </p>
            </>
          )}
        </div>
